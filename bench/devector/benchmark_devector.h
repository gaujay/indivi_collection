...
////BENCHMARK_TEMPLATE(Construct_NDefault, devector<int>            )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Construct_NDefault, devector<std::string>    )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Construct_NCopy, devector<int>             )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Construct_NCopy, devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Assign_Fill_Reserved, devector<int>            )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Assign_Fill_Reserved, devector<std::string>    )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Reserve_Double, devector<int>            )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
//BENCHMARK_TEMPLATE(Reserve_Double, std::vector<std::string> )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
//BENCHMARK_TEMPLATE(Reserve_Double, devector<std::string>    )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
////
//BENCHMARK_TEMPLATE(Shrink_Half, std::vector<int>          )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
//BENCHMARK_TEMPLATE(Shrink_Half, devector<int>             )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
//BENCHMARK_TEMPLATE(Shrink_Half, std::vector<std::string>  )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
//BENCHMARK_TEMPLATE(Shrink_Half, devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
////
...
////BENCHMARK_TEMPLATE(Resize_Double_Reserved, devector<int>             )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Resize_Double_Reserved, devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(ResizeVal_Double_Reserved, devector<int>             )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(ResizeVal_Double_Reserved, devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
////
//BENCHMARK_TEMPLATE(Squash_Offset, devector<int>        )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
//BENCHMARK_TEMPLATE(Squash_Offset, devector<std::string>)->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
////
//BENCHMARK_TEMPLATE(Clear, std::vector<std::string>  )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
//BENCHMARK_TEMPLATE(Clear, devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(PushBack,          devector<int>             )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
//BENCHMARK_TEMPLATE(PushBack_Reserved, std::vector<int>          )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
//BENCHMARK_TEMPLATE(PushBack_Reserved, devector<int>             )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(PushBack,          devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(PushBack_Reserved, devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Insert_Random_Empty,          devector<int>             )->RangeMultiplier(MULT)->Range(RMIN/16, RMAX/16)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Insert_Random_Empty_Reserved, devector<int>             )->RangeMultiplier(MULT)->Range(RMIN/16, RMAX/16)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Insert_Random_Empty,          devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/64)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Insert_Random_Empty_Reserved, devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/64)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Insert_Random_Empty,          devector<Bytes<200>>      )->RangeMultiplier(MULT)->Range(RMIN/128, RMAX/128)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Insert_Random_Empty_Reserved, devector<Bytes<200>>      )->RangeMultiplier(MULT)->Range(RMIN/128, RMAX/128)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Insert_Random,          devector<int>             )->RangeMultiplier(MULT)->Range(RMIN/16, RMAX/32)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Insert_Random_Reserved, devector<int>             )->RangeMultiplier(MULT)->Range(RMIN/16, RMAX/32)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Insert_Random,          devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/128)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Insert_Random_Reserved, devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/128)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Insert_Random,          devector<Bytes<200>>      )->RangeMultiplier(MULT)->Range(RMIN/128, RMAX/256)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Insert_Random_Reserved, devector<Bytes<200>>      )->RangeMultiplier(MULT)->Range(RMIN/128, RMAX/256)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(InsertN_Middle,          devector<int>             )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(InsertN_Middle_Reserved, devector<int>             )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(InsertN_Middle,          devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(InsertN_Middle_Reserved, devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Push_Front_Reserved,   devector<int>             )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/128)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Push_Front_Reserved,   devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/128)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(PopFront,   devector<int>             )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/64)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(PopFront,   devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/64)->Unit(benchmark::kMicrosecond);
...
BENCHMARK_TEMPLATE(Erase_Random, devector<int>            )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/128)->Unit(benchmark::kMicrosecond);
...
BENCHMARK_TEMPLATE(Erase_Random, devector<std::string>    )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/128)->Unit(benchmark::kMicrosecond);
...
BENCHMARK_TEMPLATE(Erase_Random, devector<Bytes<200>>     )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/128)->Unit(benchmark::kMicrosecond);
...
////BENCHMARK_TEMPLATE(Erase_FirstHalf, devector<int>             )->RangeMultiplier(MULT)->Range(RMAX, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Erase_FirstHalf, devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN/4, RMAX/4)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Erase_MiddleHalf, devector<int>             )->RangeMultiplier(MULT)->Range(RMAX, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Erase_MiddleHalf, devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN/4, RMAX/4)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(EraseInsert_Combo, devector<int>             )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/128)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(EraseInsert_Combo, devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/128)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(EraseInsert_Random, devector<int>             )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/64)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(EraseInsert_Random, devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/128)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(EraseInsert_Random, devector<Bytes<200>>      )->RangeMultiplier(MULT)->Range(RMIN/64, RMAX/128)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Find_Random, devector<int>             )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Find_Random, devector<std::string>     )->RangeMultiplier(MULT)->Range(RMIN/4, RMAX/4)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Increment_Each, devector<int>            )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
...
//BENCHMARK_TEMPLATE(Increment_Each, devector<std::string>    )->RangeMultiplier(MULT)->Range(RMIN, RMAX)->Unit(benchmark::kMicrosecond);
