...
#define CHECK_OFFSET  // for offset_vector<T, NEAR, START>

using namespace indivi;

static size_t next_capacity(size_t capacity, size_t minimum)
{
  while (capacity < minimum)
    capacity = (size_t)(::ceilf(capacity * INDIVI_OV_GROWTH_F));
...
{
  {
    ...
    //
    offset_vector<dClass> v1(v0);
    EXPECT_EQ(v1.size(), 2);
    EXPECT_EQ(v1.size(), v0.size());
    EXPECT_EQ(v1[1].val, 1);
    
    //
    auto pv2 = std::unique_ptr<offset_vector<dClass>>(new offset_vector<dClass>(2, 10));
    offset_vector<dClass> v2(std::forward<offset_vector<dClass>>(*pv2));
    EXPECT_EQ(v2.size(), 2);
    pv2.release();
    EXPECT_EQ(v2[1].val, 10);
    
    //
    offset_vector<dClass> v3({1,2,3});
    EXPECT_EQ(v3.size(), 3);
    EXPECT_EQ(v3[0].val, 1);
    EXPECT_EQ(v3[2].val, 3);
    
    //
    offset_vector<dClass> v4;
    EXPECT_EQ(v4.size(), 0);
...
{
  {
    ...
    //
    auto pv3 = std::unique_ptr<offset_vector<dClass>>(new offset_vector<dClass>(1, 11));
    offset_vector<dClass> v3(2, -11);
    v3 = std::forward<offset_vector<dClass>>(*pv3);
    EXPECT_EQ(v3.size(), 1);
    pv3.release();
    EXPECT_EQ(v3[0].val, 11);
    
    //
    offset_vector<dClass> v4(1, 13);
    v4 = {1,2,3};
    EXPECT_EQ(v4.size(), 3);
    ...
    //
    offset_vector<dClass> v6(3, 14);
    offset_vector<dClass> v7;
    v6 = v7;
    EXPECT_EQ(v6.size(), 0);
    EXPECT_EQ(v6.capacity(), 3);
    
    offset_vector<dClass> v8;
    v8.reserve(2);
    v6 = v8;
    EXPECT_EQ(v6.size(), 0);
    EXPECT_EQ(v6.capacity(), 3);
...
TEST(VectorTest, Assign)
{
  {
    //
    offset_vector<dClass> v0(1);
    v0.assign(2, 18);
    EXPECT_EQ(v0.size(), 2);
    EXPECT_EQ(v0[1].val, 18);
    
    //
    offset_vector<dClass> v1(3);
    v1.assign(2, -18);
    EXPECT_EQ(v1.size(), 2);
...
{
  {
    ...
    //
    offset_vector<dClass> v1(1, 6);
    v1.reserve(2);
    EXPECT_EQ(v1.size(), 1);
    EXPECT_EQ(v1[0].val, 6);
    
    //
    offset_vector<int> v2({1,2});
    v2.reserve(3);
    EXPECT_EQ(v2.size(), 2);
...
TEST(VectorTest, Resize)
{
  {
    //
    offset_vector<dClass> v0(3, 7);
    v0.resize(1);
    EXPECT_EQ(v0.size(), 1);
    EXPECT_EQ(v0[0].val, 7);
    
    //
    offset_vector<dClass> v1(1, 8);
    v1.resize(3);
    EXPECT_EQ(v1.size(), 3);
...
TEST(VectorTest, Erase)
{
  {
    //
    offset_vector<dClass> v0 = {1,2,3,4};
    ...
    //
    offset_vector<dClass> v1 = {1,2,3,4};
    ...
    //
    offset_vector<dClass> v3({1,2,3,4});
    ...
    //
    offset_vector<dClass> v4({1,2,3,4,5,6});
    v4.pop_front();
    v4.pop_back();
    ...
    //
    offset_vector<dClass> v5({1,2,3,-4,-5,6});
    ...
    //
    offset_vector<dClass> v6({1,-2,-3,4,5,6});
    ...
    //
    offset_vector<dClass> v8({1,2,3,4,5});
    auto v8_2 = v8;
...
TEST(VectorTest, InsertN_Copy)
{
  {
    // Left-shift
    //
    offset_vector<dClass> v0({1,2,3});
    v0.pop_front();
    ...
    //
    offset_vector<dClass> v1({1,2,3,4,5});
    v1.pop_front();
    ...
    //
    offset_vector<dClass> v2({1,2,3,4,5});
    v2.pop_front();
    v2.pop_front();
    ...
    //
    offset_vector<dClass> v4({1,2,3,4});
    v4.pop_front();
    v4.pop_front();
    ...
    //
    offset_vector<dClass> v6{-1,0,1,2,3,4};
    v6.pop_front();
    v6.pop_back();
    ...
    //
    offset_vector<dClass> v7{1,2,3,4};
    v7.pop_back();
    v7.pop_back();
    ...
    // Right-shift
    //
    offset_vector<dClass> v8{1,2,3,4};
    v8.pop_back();
    ...
    //
    offset_vector<dClass> v9{0,1,2,3,4,5};
    v9.pop_back();
    ...
    //
    offset_vector<dClass> v10{0,1,2,3,4,5,6};
    v10.pop_front();
    v10.pop_front();
    v10.pop_back();
    v10.pop_back();
    ...
    //
    offset_vector<dClass> v11{0,1,2,3};
    v11.pop_front();
    v11.pop_back();
    ...
    // Both-shift
    //
    offset_vector<dClass> v20{1,2,3,4,5,6};
    v20.pop_front();
    v20.pop_back();
    ...
    //
    offset_vector<dClass> v21{1,2,3,4,5};
    v21.pop_front();
    v21.pop_back();
    v21.pop_back();
    ...
    //
    offset_vector<dClass> v22{1,2,3,4,5,6};
    v22.pop_front();
    v22.pop_front();
    v22.pop_back();
    v22.pop_back();
    ...
    //
    offset_vector<dClass> v23{1,2,3,4,5,6,7};
    v23.pop_front();
    v23.pop_back();
...
TEST(VectorTest, AddRemove)
{
  {
    //
    offset_vector<dClass> v0(2);
...
TEST(VectorTest, NonMember)
{
  {
    //
    offset_vector<int> v0({1,2,3});
    offset_vector<int> v1({1,2,3});
    offset_vector<int> v2({4,5,6});
...
TEST(VectorTest, ReallocMode)
{
  {
    //
    offset_vector<dClass, ShiftMode::NEAR, ReallocMode::END> v0;
    v0.reserve(3);
    ...
    //
    offset_vector<dClass, ShiftMode::NEAR, ReallocMode::CENTER> v1;
    v1.reserve(3);
    EXPECT_EQ(v1.offset(), 1);
    v1.emplace_front(1);
    EXPECT_EQ(v1.offset(), 0);
...
TEST(VectorTest, Throwing)
{
  {
    //
    EXPECT_ANY_THROW(offset_vector<eClassCtr0> v0(3));
    eClassCtr0::resetOpCounters();
    
    //
    EXPECT_ANY_THROW(offset_vector<eClassCtrCpy> v1(3,0));
    eClassCtrCpy::resetOpCounters();
    
    //
    EXPECT_ANY_THROW(offset_vector<eClassCtrCpy> v2({1,2,3}));
    eClassCtrCpy::resetOpCounters();
    
    //
    offset_vector<eClassCtrCpy> v3;
    v3.reserve(2);
    v3.emplace_back(1);
    v3.emplace_back(2);
    EXPECT_ANY_THROW(offset_vector<eClassCtrCpy> v4(v3));
    EXPECT_NO_THROW(offset_vector<eClassCtrCpy> v4(std::move(v3)));
    eClassCtrCpy::resetOpCounters();
    
    //
    offset_vector<eClassCtrCpy> v5;
    v5.reserve(2);
    v5.emplace_back(1);
    v5.emplace_back(2);
    offset_vector<eClassCtrCpy> v6;
    EXPECT_ANY_THROW(v6 = v5);
    eClassCtrCpy::resetOpCounters();
    
    //
    offset_vector<eClassAsgCpy> v7(3,0);
    offset_vector<eClassAsgCpy> v8(4,0);
    v8.pop_front();
    ...
    //
    offset_vector<eClassAsgCpy> v9(3,0);
    EXPECT_ANY_THROW(v9.assign(2,-1));
    eClassAsgCpy::resetOpCounters();
    
    offset_vector<eClassAsgCpy> v10(2,0);
    EXPECT_ANY_THROW(v9.assign(v10.begin(),v10.end()));
    eClassAsgCpy::resetOpCounters();
    
    //
    offset_vector<eClassCtrMve> v11(5,0);
    ...
    //
    offset_vector<eClassCtrMve> v12(5,0);
